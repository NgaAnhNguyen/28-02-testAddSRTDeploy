...
//    @Value("${cloudinary.file_upload_URL}")
    public  String fileUploadURL1 = "https://res.cloudinary.com/duli95mss/";
    @Resource
    ...
    public String uploadFile(MultipartFile file, String resourceType) {
        try {
            ...
            String fileUploadURL2 = "/upload/v1/";
    ...
    public String extractPublicId(String fileUrl, String resourceType) {
        ...
        if (fileUrl.startsWith(prefix)) {
            ...
            int lastDotIndex = fileName.lastIndexOf("."); // Tìm vị trí dấu '.'

            if (lastDotIndex != -1) {
                return fileName.substring(0, lastDotIndex); // Cắt bỏ phần đuôi mở rộng
            }
        }
        return null;
    }
